...
class gazebo_env(py_environment.PyEnvironment):
    ...
    regions = [
        ...
        {"label": "forward", "distances": [0, 0.35, 0.75, 1], "max": 4},
        {"label": "forward-right", "distances": [0, 1], "max": 2},
        {"label": "right", "distances": [0, 0.25, 0.5, 0.75, 1], "max": 5},
    ]
    ...
    def _step(self, action):
        ...
        if self._episode_ended == True:
            ...
            return ts.transition(newState, reward, discount=0.99)
    ...
    def laser_callback(self, msg):
        ...
        #self.ranges = self.check_ranges(msg.ranges, self.range_min, self.range_max)
